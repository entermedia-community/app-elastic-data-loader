...
//    			request.mapping(builder);
		...
		// request.alias(new
		// Alias("twitter_alias").filter(QueryBuilders.termQuery("user", "kimchy")));
	...
	/*
	 * public static void getMapping(RestHighLevelClient client, String index) { try
	 * { GetMappingsRequest request = new GetMappingsRequest();
	 * request.indices("twitter"); GetMappingsResponse getMappingResponse =
	 * client.indices().getMapping(request, RequestOptions.DEFAULT); Map<String,
	 * MappingMetadata> allMappings = getMappingResponse.mappings(); MappingMetadata
	 * indexMapping = allMappings.get(index); Map<String, Object> mapping =
	 * indexMapping.sourceAsMap(); System.out.println(mapping.toString()); } catch
	...
	/*
	 * public void setMapping(RestHighLevelClient client, String catalogid, String
	 * module) throws Exception { System.out.println( "maping mapping "+ catalogid +
	 * " " + module );
	 * 
	 * String mapping = readMappingfile(GITHOME + "/data/"+ module +
	 * "-mapping.json");
	 * 
	 ...
	 * builder.startObject("message"); // { // builder.field("type", "text"); // }
	 ...
	 * putMappingResponse = client.indices().putMapping(request,
	 * RequestOptions.DEFAULT); }
	 */
	/*
	 * public void setMapping(RestHighLevelClient client, String indexname, String
	 * tablename) throws Exception { //public void putMapping(MediaArchive
	 * mediaarchive, String searchtype, Page upload, String tempindex) throws
	 * Exception{
	 * 
	 * AdminClient admin = client.admin(); PutMappingRequest req =
	 * Requests.putMappingRequest(indexname);//.type(tablename); String
	 * uploadGetContent = upload.getContent() req = req.source(uploadGetContent);
	 * 
	 * req.validate(); PutMappingResponse pres =
